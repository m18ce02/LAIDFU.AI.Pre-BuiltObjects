...
- **v1.0.1** (2025-12-05): 修正配置文档的错误描述，并优化说明内容，使其更清晰易读。
...
2. 将压缩文件解压至本地文件夹。
3. 参考解压后的“Objects安装与配置文档_AI 对话转销售订单数据载体（进阶版）_v1.0.1.pdf”完成配置。
...
- 版本详细要求可在每个 Objects文件夹的“Objects安装与配置文档_AI 对话转销售订单数据载体（进阶版）_v1.0.1.pdf”文档中找到。
### 3. 环境验证：
